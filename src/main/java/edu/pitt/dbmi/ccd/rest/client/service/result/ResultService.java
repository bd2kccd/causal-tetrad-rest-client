 ...
 * 
 */
public class ResultService extends AbstractRequestService implements
	AbstractResultRequest {

    public ResultService(RestHttpsClient restHttpsClient, String scheme,
	...
	URIBuilder uriBuilder = new URIBuilder().setHost(hostname)
		.setScheme(scheme)
		.setPath("/" + REST_API + "/" + jsonWebToken.getUserId() + "/" + RESULTS)
		.setPort(port);
	...
	URIBuilder uriBuilder = new URIBuilder()
		...
		.setScheme(scheme)
		.setPath(
			"/" + REST_API + "/" + jsonWebToken.getUserId() + "/" + RESULTS + "/"
				+ fileName).setPort(port);
	...
	URIBuilder uriBuilder = new URIBuilder()
		...
		.setPath(
			"/" + REST_API + "/" + jsonWebToken.getUserId() + "/" + RESULTS + "/"
				+ COMPARISONS + "/" + fileName).setPort(port);
	...
	URIBuilder uriBuilder = new URIBuilder()
		...
		.setPath(
			"/" + REST_API + "/" + jsonWebToken.getUserId() + "/" + RESULTS + "/"
				+ COMPARE + "/" + fileNames).setPort(port);
